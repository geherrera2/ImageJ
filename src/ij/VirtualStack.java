...
public class VirtualStack extends ImageStack {
	 ...
	 * @see #addSlice(String)
	 * @see <a href=
	 *      "http://wsr.imagej.net/macros/js/OpenAsVirtualStack.js">OpenAsVirtualStack.js</a>
	 */
	...
	/**
	 * Sets the table that translates slice numbers of hyperstacks not in default
	 * CZT order.
	 */
	...
	public int translate(int n) {
		...
		// IJLog.log("translate: "+n+" "+n2+" "+getSize()+"
		// "+(indexes!=null?indexes.length:null));
		return n2;
	}
