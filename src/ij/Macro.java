...
public class Macro {
	...
	public static void abort() {
		// IJLog.log("Abort: "+Thread.currentThread().getName());
		abort = true;
	...
	public static String getOptions() {
		...
		// IJLog.log("getOptions: "+threadName+" "+Thread.currentThread().hashCode());
		// //ts
	...
	public static void setOptions(String options) {
		// IJLog.log("setOptions: "+Thread.currentThread().getName()+"
