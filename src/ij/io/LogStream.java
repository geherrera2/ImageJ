 ...
 *         See Also: Redirect_System_Streams
 *         (http://staff.fh-hagenberg.at/burger/imagej/)
 */
public class LogStream extends PrintStream {
	...
	/**
	 * Redirects all output sent to <code>System.out</code> and
	 * <code>System.err</code> to ImageJ's log console
	 ...
	 *               Pass <code>null</code> to use the default prefix or an empty
	 *               string to
	 *               remove the prefix.
	 */
	 ...
	 * Note that a reference to the current output stream can also be obtained
	 * directly from
	 * the {@code System.out} field.
	 * 
	 * @return A reference to the {@code PrintStream} object currently substituting
	 *         {@code System.out}
	...
	/**
	 * Use this method to revert both <code>System.out</code> and
	...
	private void ejectBuffer() {
		IJLog.log(prefix + byteStream.toString());
		byteStream.reset();
	}
