...
public class FileSaver {
	...
	public boolean save() {
		...
		if (validName && ofi.fileFormat == FileInfo.TIFF && ofi.directory != null && !ofi.directory.equals("")
				&& (ofi.url == null || ofi.url.equals(""))) {
			name = imp.getTitle();
	...
	// Append a string to a StringBuffer with escaped special characters as needed
