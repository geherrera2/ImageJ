...
public class TiffEncoder {
	...
	public TiffEncoder(FileInfo fi) {
		...
		imageOffset = HDR_SIZE + ifdSize + bpsSize + descriptionSize + scaleSize + colorMapSize + nMetaDataEntries * 4
				+ metaDataSize;
		fi.offset = (int) imageOffset;
		// ij.IJLog.log(imageOffset+", "+ifdSize+", "+bpsSize+", "+descriptionSize+",
		// "+scaleSize+", "+colorMapSize+", "+nMetaDataEntries*4+", "+metaDataSize);
	}
