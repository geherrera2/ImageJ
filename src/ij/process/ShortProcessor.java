...
public class ShortProcessor extends ImageProcessor {
	...
	/**
	 * @deprecated
	 *             16 bit images are normally unsigned but signed images can be
	 *             simulated by
	 *             subtracting 32768 and using a calibration function to restore the
	 *             original values.
	 */
	 ...
	 * by
	 * subtracting 32768 and using a calibration function to restore the original
	 * values.
	 */
	...
	public void setThreshold(double minThreshold, double maxThreshold, int lutUpdate) {
		...
		// ij.IJLog.log("setThreshold: "+lutUpdateMode+" "+this.minThreshold+"
		// "+this.maxThreshold);
	}
