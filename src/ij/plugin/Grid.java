...
public class Grid implements PlugIn, DialogListener {
	...
	private static String[] colors = { "Red", "Green", "Blue", "Magenta", "Cyan", "Yellow", "Orange", "Black",
			"White" };
	...
	private void drawCircles(double size) {
		...
		if (R < 1)
			R = 1;
		if (bold && type.equals(types[POINTS]))
			R *= 1.5;
	...
	private void drawGrid() {
		// IJLog.log(centered+" "+xstart+" "+ystart);
