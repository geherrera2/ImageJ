 ...
 *         Improved GUI, support of image coordinates and z-slices by Joachim
 *         Walter <correspondence@walter-witzenhausen.de>
 * 
 */
public class SyncWindows extends PlugInFrame implements
	...
	public String commandExecuting(String command) {
		if (vwins != null && cScaling != null && cScaling.getState()
