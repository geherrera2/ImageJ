...
public class EventListener implements PlugIn, IJEventListener, ImageListener, RoiListener, CommandListener {
	...
	public void run(String arg) {
		...
		IJLog.log("EventListener started");
	}
	...
	public void imageOpened(ImagePlus imp) {
		IJLog.log("Image opened: \"" + imp.getTitle() + "\"" + edt());
	}

	// Called when an image is closed
	public void imageClosed(ImagePlus imp) {
		IJLog.log("Image closed: \"" + imp.getTitle() + "\"" + edt());
	}

	// Called when an image's pixel data is updated
	public void imageUpdated(ImagePlus imp) {
		IJLog.log("Image updated: \"" + imp.getTitle() + "\"" + edt());
	}

	// Called when an image is saved
	public void imageSaved(ImagePlus imp) {
		IJLog.log("Image saved: \"" + imp.getTitle() + "\"" + edt());
	}
	...
	public String commandExecuting(String command) {
		IJLog.log("Command executed: \"" + command + "\" command");
		return command;
	}
	...
	public void roiModified(ImagePlus img, int id) {
		...
		IJLog.log("ROI modified: " + (img != null ? img.getTitle() : "") + ", " + type);
	}
