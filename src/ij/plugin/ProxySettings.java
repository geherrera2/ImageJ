...
public class ProxySettings implements PlugIn {
	...
	public void logProperties() {
		IJLog.log("proxy set: " + System.getProperty("proxySet"));
		IJLog.log("http proxy host: " + System.getProperty("http.proxyHost"));
		IJLog.log("http proxy port: " + System.getProperty("http.proxyPort"));
		IJLog.log("https proxy host: " + System.getProperty("https.proxyHost"));
		IJLog.log("https proxy port: " + System.getProperty("https.proxyPort"));
		IJLog.log("java.net.useSystemProxies: " + System.getProperty("java.net.useSystemProxies"));
	}
