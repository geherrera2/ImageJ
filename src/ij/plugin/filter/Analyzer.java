...
public class Analyzer implements PlugInFilter, Measurements {
	...
	/**
	 * Measures the image or selection and adds the results to the default results
	 * table.
	 */
	public void measure() {
	 ...
	 * if (columns==0)
	 * return;
	 * IJLog.log("Headings: "+headings.length+" "+rt.getColumnHeading(ResultsTable.
	 * LAST_HEADING));
	 * for (int i=0; i<columns; i++) {
	 * if (headings[i]!=null)
	 * IJLog.log("   "+i+" "+headings[i]+" "+rt.getColumnIndex(headings[i]));
	 * }
	 * }
	 */
