...
public class ImageProperties implements PlugInFilter, TextListener {
	...
	void showDialog(ImagePlus imp) {
		...
		if (project == null)
			project = "";
		if (project.contains("Min") || project.contains("min"))
			project = "Min";
		if (project.contains("Max") || project.contains("max"))
			project = "Max";
		if (!(project.equals("Min") || project.equals("Max")))
			project = "Sum";
