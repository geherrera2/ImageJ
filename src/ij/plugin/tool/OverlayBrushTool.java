...
public class OverlayBrushTool extends PlugInTool implements Runnable {
	private final static int UNCONSTRAINED = 0, HORIZONTAL = 1, VERTICAL = 2, DO_RESIZE = 3, RESIZED = 4, IDLE = 5; // mode
																													// flags
	...
	public void mousePressed(ImagePlus imp, MouseEvent e) {
		...
		if ((e.getModifiers() & resizeMask) == resizeMask) {
			...
			// Don't use awt.robot to pick the color, it is influenced by screen color
			// calibration
