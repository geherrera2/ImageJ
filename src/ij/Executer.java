...
public class Executer implements Runnable {
	...
	/**
	 * If the foreground image is locked during a filter operation with
	...
	boolean allowedWithLockedImage(String className) {
		return className.equals("ij.plugin.Zoom") ||
				...
				className.equals("ij.plugin.SimpleCommands") || // includes Plugins>Utiltites>Reset (needed to reset a
																// locked image)
