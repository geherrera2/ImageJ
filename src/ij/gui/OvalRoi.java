...
public class OvalRoi extends Roi {
	 ...
	 * The superclass method of calculating this via the convex hull is less
	 * accurate for the MinFeret
	...
	protected void moveHandle(int sx, int sy) {
		...
		// IJLog.log("moveHandle: "+activeHandle+" "+ox+" "+oy);
	...
	/**
	 * Returns this OvalRoi as a Polygon that outlines the mask, in image pixel
	 * coordinates.
	 */
	...
	public FloatPolygon getFloatPolygon() {
		ShapeRoi sr = new ShapeRoi(
				new java.awt.geom.Ellipse2D.Double(x - 0.0004, y - 0.0004, width + 0.0008, height + 0.0008)); // better
																												// accuracy
																												// with
																												// slightly
																												// increased
	...
	/**
	 * Returns the number of corner points in the mask of this selection; equivalent
	 * to getPolygon().npoints.
	 */
	public int size() {
	...
	/**
	 * Tests whether the center of the specified pixel is inside the boundary of
	 * this OvalRoi.
	...
	/**
	 * Returns the perimeter length using Ramanujan's approximation for the
